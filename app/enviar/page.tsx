...
import { FormularioDeEnvio } from '@/components/enviar/formulario'
...
/* Mesmo visual da inscrição de voluntários (/participe): a logo oficial numa faixa branca, cartão no fundo cinza. */
