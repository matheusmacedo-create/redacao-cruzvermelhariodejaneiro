...
export default async function InicioDoMembro() {
  ...
  const [perfil, { formacoes, atividades }, cursos, oportunidades] = await Promise.all([perfilDoMembro(m), historicoDoMembro(m), catalogoDoMembro(m), oportunidadesDoMembro(m)])
  ...
  return <InicioView nome={m.nome} perfil={perfil} formacoes={formacoes} atividades={atividades} hoje={hojeEmSaoPaulo()} hora={hora} continuar={continuar} proxima={proxima} />
}
