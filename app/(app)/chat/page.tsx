...
export default async function ChatPage() {
  ...
  if (!destino) return <p className="text-sm text-muted-foreground">Você ainda não está em nenhuma conversa. Peça para alguém do Palácio Virtual chamar você para um canal.</p>
