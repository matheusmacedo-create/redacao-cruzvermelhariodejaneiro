...
export default async function BibliotecaPage() {
  ...
  return <div><PageHeader title="Biblioteca" description="Arquivos privados compartilhados com a equipe da Redação CVRJ." /><LibraryView initialFiles={files} usedBytes={used} limitBytes={WORKSPACE_STORAGE_LIMIT} /></div>
}
