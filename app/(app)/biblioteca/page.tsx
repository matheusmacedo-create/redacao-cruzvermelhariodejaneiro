...
export default async function BibliotecaPage() {
  ...
  return <div><PageHeader title="Biblioteca" description="Arquivos privados compartilhados com a equipe da Redação Cruz Vermelha Brasileira Rio de Janeiro." /><LibraryView initialFiles={files} usedBytes={used} limitBytes={WORKSPACE_STORAGE_LIMIT} workspaceId={context.workspace.id} /></div>
}
