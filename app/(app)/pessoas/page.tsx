...
export default async function PessoasPage() {
  ...
  return <div><PageHeader title="Pessoas" description="Colaboradores vinculados ao espaço atual." actions={pode(context.role, 'usuarios.gerenciar') ? <Button size="lg" render={<Link href="/usuarios"/>}><Plus className="size-4"/>Adicionar colaborador</Button> : undefined}/><PeopleView people={people}/></div>
}
