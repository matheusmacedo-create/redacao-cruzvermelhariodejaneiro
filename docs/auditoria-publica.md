...
Migrações (só acréscimos): `supabase/migrations/20260925170000_cvrj_auditoria.sql` (a trilha e os
ganchos de matérias, comunicados, ofícios e certificados) e `20260925171000_cvrj_transparencia.sql`
...
Migração `20260925171000_cvrj_transparencia.sql`:
