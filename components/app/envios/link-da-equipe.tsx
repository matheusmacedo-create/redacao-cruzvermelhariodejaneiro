  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-4 sm:flex-row sm:items-center" data-ajuda="envios.link">
      ...
      <div className="flex min-w-0 flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">Qualquer pessoa com o link manda fotos, vídeos, áudios e o relato — sem login. Imprima o QR code no cartaz da ação ou mande o link no grupo da equipe.</p>
