  ...
  tour: [
    {
      ...
      texto: 'Tudo o que tem data, de todas as áreas, num lugar só. Nada é copiado: cada item continua morando na sua área, e tocar nele mostra o detalhe e o caminho até lá.',
    },
    {
      alvo: 'calendario.camadas',
      titulo: 'Minhas agendas',
      texto: 'Cada área é uma camada com a sua cor. Desmarque para esconder; “só esta” deixa só aquela ligada. A escolha fica guardada para você, e os alertas acompanham.',
    },
    {
      alvo: 'calendario.mes',
      titulo: 'Andar no tempo',
      texto: 'As setas vão para o período anterior e o próximo; “Hoje” volta para a data de hoje.',
    },
    {
      alvo: 'calendario.visao',
      titulo: 'Mês, semana ou lista',
      texto: '“Mês” mostra a grade; “Semana”, os sete dias com os títulos inteiros; “Lista”, os próximos 30 dias em ordem.',
    },
    {
      alvo: 'calendario.grade',
      titulo: 'Os itens',
      texto: 'A cor diz a camada; embaixo vêm horário, canal e situação (“Em aprovação”, “Agendado”…). Feriados aparecem em cinza sob o número do dia, e meses temáticos e campanhas longas ficam na faixa “Durante o período”.',
    },
    {
      alvo: 'calendario.alertas',
      titulo: 'Pede atenção',
      texto: 'Data comemorativa chegando sem pauta, publicação perto da hora sem aprovação, semana sem nada agendado, muitos posts no mesmo canal no mesmo dia, evento em feriado e contas ou documentos vencendo.',
    },
    {
    ...
    {
      alvo: 'calendario.configurar',
      titulo: 'Configurar',
      texto: 'Aqui você liga o resumo semanal por e-mail, gera o link para ver tudo no Google Agenda ou no celular e, com permissão, cuida da lista de datas comemorativas.',
    },
  ],
  tarefas: [
    {
      id: 'ligar-desligar-camadas',
      titulo: 'Esconder ou mostrar uma área',
      passos: [
        'Em “Minhas agendas” (no celular, toque em “Camadas”), desmarque a área que quer esconder.',
        'Para ver uma área sozinha, passe o mouse sobre ela e toque em “só esta”.',
        'Para voltar a ver tudo, toque em “Ligar todas”.',
      ],
      dica: 'A escolha é só sua e fica guardada: na próxima vez, o calendário abre do mesmo jeito. Os alertas e o resumo semanal seguem as camadas ligadas.',
    },
    {
      id: 'agendar-data',
      titulo: 'Agendar uma data',
      passos: [
        'Toque em “Agendar” (ou no “+” de um dia, que já vem com a data).',
      ...
      dica: 'Com “Criar pauta integrada”, nasce uma pauta em “Entrada” com o mesmo título, a data como prazo e você como responsável.',
    },
    {
      ...
      passos: [
        ...
        'A pauta abre já com o prazo na data; o alerta some.',
      ],
      dica: 'Cada data vira uma pauta por ano. Se alguém já criou, o item mostra “Já tem pauta neste ano” e “Abrir a pauta”.',
    },
    {
      ...
      passos: [
        ...
        'Toque em “Adicionar ao Google Agenda”, ou em “Abrir no calendário do aparelho” no iPhone. No Outlook, use “Assinar da web” e cole o link.',
      ],
      dica: 'O link aparece uma vez só e é só seu: quem tiver o link vê as datas. Levam as camadas ligadas na hora, menos Financeiro, Frota, Chamados e Aniversários, que nunca saem do sistema. “Desligar link” corta o acesso.',
    },
    {
      id: 'resumo-semanal',
      titulo: 'Receber o resumo da semana por e-mail',
      passos: [
        'Toque em “Configurar”.',
        'Ligue “Resumo semanal por e-mail”.',
      ],
      dica: 'Chega toda segunda de manhã no seu e-mail de recuperação, com a semana dia a dia e o que pede atenção. Só recebe quem ligar.',
    },
    {
      id: 'datas-comemorativas',
      titulo: 'Cadastrar uma data comemorativa da filial',
      passos: [
        'Toque em “Configurar” e desça até “Datas comemorativas”.',
        'Toque em “Nova”.',
        'Dê o nome, escolha quando cai (dia fixo, um dia da semana como “2º sábado” ou o mês inteiro) e quantos dias antes o alerta começa.',
        'Toque em “Salvar”.',
      ],
      dica: 'Só administradores e editores cadastram e editam. Uma data que não interessa mais pode ser desativada e reativada depois.',
    },
  ],
  perguntas: [
    {
      ...
      resposta: 'Das próprias áreas, lidos na hora: pautas (prazo) e projetos (marcos); publicações agendadas e pacotes com horário; oportunidades do voluntariado; campanhas da escola e de doações; contas em aberto do financeiro; documentos da frota; chamados em que você é o responsável; fim de vigência e prestação de contas das parcerias; aniversários da equipe; e a lista de datas comemorativas. Os feriados são calculados.',
      termos: ['origem', 'agenda', 'eventos', 'datas', 'camadas'],
    },
    {
      id: 'camada-que-nao-aparece',
      pergunta: 'Por que não vejo a camada do Financeiro (ou de outra área)?',
      resposta: 'Cada camada aparece para quem tem acesso à área: Financeiro, Frota, Doações, Voluntariado, Aniversários, Escola e Parcerias dependem do acesso dado em cada uma delas. Peça o acesso a um administrador.',
      termos: ['sumiu', 'não aparece', 'acesso', 'permissão'],
    },
    {
      id: 'pauta-fora-do-calendario',
      pergunta: 'Por que a minha pauta não aparece no calendário?',
      resposta: 'A pauta aparece no dia do prazo. Sem prazo, ou arquivada, ela não entra. Confira também se a camada “Pautas e projetos” está ligada.',
      termos: ['prazo', 'data', 'sumiu', 'não aparece'],
    },
    {
      id: 'mudar-ou-apagar-data',
      pergunta: 'Dá para mudar ou apagar uma data pelo calendário?',
      resposta: 'Não: a data é mudada onde o item mora. Toque no item e em “Abrir” para ir até a pauta, o conteúdo, a conta ou a oportunidade. Os agendamentos avulsos ligados a uma pauta somem junto quando a pauta é excluída.',
      termos: ['editar', 'excluir', 'remover', 'apagar agendamento', 'mudar data'],
    },
    {
      id: 'alertas',
      pergunta: 'Como funcionam os alertas de “Pede atenção”?',
      resposta: 'São regras simples sobre as camadas ligadas: data comemorativa dentro da antecedência sem pauta; publicação nas próximas 48 horas ainda em rascunho ou em aprovação; semana atual ou seguinte sem publicação; três ou mais posts no mesmo canal no mesmo dia; ação ou publicação em feriado; conta ou documento vencendo em até 7 dias ou já vencido. Desligar a camada tira os alertas dela.',
      termos: ['avisos', 'alerta', 'atenção', 'sem pauta', 'aprovação'],
    },
    {
      id: 'link-perdido',
      pergunta: 'Perdi o link do Google Agenda. E agora?',
      resposta: 'O link não fica guardado em lugar nenhum, nem para os administradores. Em “Configurar”, toque em “Gerar novo link”: o antigo para de funcionar e você assina de novo com o novo.',
      termos: ['ics', 'assinatura', 'google agenda', 'outlook', 'iphone'],
    },
    {
      id: 'demora-no-google',
      pergunta: 'Mudei uma data e o Google Agenda ainda mostra a antiga. Por quê?',
      resposta: 'Quem decide quando buscar de novo é o Google (ou o Outlook, ou o celular), e costuma levar algumas horas. O calendário daqui está sempre atualizado.',
      termos: ['atraso', 'sincronizar', 'atualizar', 'google'],
    },
    {
      id: 'calendario-no-celular',
      pergunta: 'Como fica o calendário no celular?',
      resposta: 'No mês, a grade vira uma lista só com os dias que têm alguma coisa. As camadas abrem pelo botão “Camadas”, e “Pede atenção” fica depois da lista.',
