  ...
  tour: [
    {
      ...
      texto: 'Prazos, atividades e publicações da equipe, mês a mês. As datas vêm do registro das pautas, dos agendamentos feitos aqui e das publicações agendadas.',
    },
    {
      alvo: 'calendario.mes',
