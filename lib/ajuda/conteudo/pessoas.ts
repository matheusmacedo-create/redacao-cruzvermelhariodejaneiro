...
const DIRETORIO: GuiaDaArea = {
  ...
  perguntas: [
    ...
    },
    {
      ...
      resposta: 'Quem é administrador cria contas, muda papéis e vê tudo na Redação. O alerta aparece, só para administradores, quando há mais de 2 contas administradoras; o recomendado é 1 ou 2, um titular e um reserva. “Revisar papéis” leva a “Usuários e permissões”.',
