...
const RESULTADOS: GuiaDaArea = {
  href: '/impacto',
  paraQueServe: 'Resultados mostra o que aconteceu depois da publicação, nos últimos 30 dias: quantos pacotes e publicações saíram, em quais canais, e como andam os projetos ativos. Por enquanto, só com dados que a Redação registra; alcance, engajamento e dados do site entram quando as fontes de analytics forem conectadas, sem números estimados.',
  ...
  tour: [
    {
      ...
      texto: 'O efeito do que já saiu, nos últimos 30 dias. Por enquanto, só dados que a Redação registra; alcance e engajamento chegam quando as fontes de analytics forem conectadas.',
      lado: 'bottom',
    },
    {
  ...
  perguntas: [
    {
      ...
      resposta: 'Porque essas fontes ainda não estão conectadas. Esta primeira versão usa só o que a Redação já registra com segurança. Alcance, visualizações, seguidores, engajamento e dados do site vão aparecer quando as fontes de analytics forem ligadas, sem números estimados ou inventados.',
